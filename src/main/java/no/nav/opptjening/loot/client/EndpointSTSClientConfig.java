...
public class EndpointSTSClientConfig {
    ...
    public static final String STS_SAML_POLICY = "classpath:requestSamlPolicy.xml";
    public static final String STS_SAML_POLICY_NO_TRANSPORT_BINDING = "classpath:requestSamlPolicyNoTransportBinding.xml";
